        ...
        <div class="main-panel">
            ...
            ";
                ...
                <div class="page-header">
                    ...
                    <h3 class="page-title">View LeaderBoard According to Exam</h3>
                            ...
                            while ($rew = $examResu->fetch_assoc()) {
                                ...
                                <div class='card'>
                                    <div class='card-body'>
                                        ...
                                        <a href='leaderboard.php?examId=" . $rew['id'] . "' class='btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn'>View Leaderboard</a>
                                    </div>
                                </div>
                            </div>";
                            }
