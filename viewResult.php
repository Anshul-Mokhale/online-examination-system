                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <a href="print.php?id=<?= $sid ?>&examId=<?= $examId ?>"
                    ...
                    <div class='col-md-12' style="margin-bottom: 1em;">
                        <div class='card' style="display:flex; justify-content:space-between; flex-direction:row">
                            <div class='card-body' style="align-items:start">
                                ...
                                $sqe = "SELECT COUNT(*) AS row_count FROM question_$examId";
                                ...
                                $swq2 = "SELECT * FROM submissions WHERE student_id = ? AND exam_id = ?";
                                        ...
                                        foreach ($section_answers as $question => $answer) {
                                            ...
                                            if ($result5->num_rows > 0) {
                                                while ($swss = $result5->fetch_assoc()) {
                                                    ...
                                                    echo '<ul class="choices-container">';
                                                    ...
                                                    if ($answer == $swss['correct_answer']) {
                                                        if (strpos($answer, 'choice_image') !== false) {
                                                            ...
                                                            echo "<p>Given Answer: <img src='admin/uploads/$answer'> <i class='fa-solid fa-check'></i></p>";
                                                        } else {
                                                        ...
                                                        if (strpos($answer, 'choice_image') !== false) {
                                                            // If "choice_image" is found in the answer, display the image
                                                            echo "<p>Given Answer: <img src='admin/uploads/$answer'> <i class='fa-solid fa-xmark'></i></p>";
                                                        } else {
                                                            // If "choice_image" is not found, just display the text with the checkmark
