...
<body>
    <nav class="NavBar">
        <?php
        $fetchSql = "SELECT exam_name FROM exams WHERE id='$vauesd'";

        $result = $mysql_connection->query($fetchSql);
        ...
        if ($result->num_rows > 0) {
            ...
            // Now you can use $exam_name as needed
            // echo "<p>Exam Name: " . $exam_name . "</p>";
        } else {
            // echo "No exam found with the given ID.";
        }
        ?>
        <img src="assets/images/IMAGELOGO.svg" alt=""> <?= $exam_name ?>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showCurrentSection() {
                ...
                if (currentQuestion.image_path) {
                    ...
                    imageDiv.classList.add('quest_image');
                    imageDiv.innerHTML = "<img src='admin/" + currentQuestion.image_path + "' style='height:100px; width:100px;'>";
                    // imageDiv.innerHTML = currentQuestion.image_path;
