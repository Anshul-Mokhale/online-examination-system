                        ...
                        <div class="col stretch-card">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form class="forms-sample" method="post" action="BackendAPI/addDemoSection.php">
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $sqle = "SELECT * FROM demosections WHERE id = '$id'";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='text-center'><a href='viewDemoquestion.php?id=$id&sec=" . $row['sr'] . "' class='page-title-icon bg-gradient-primary text-white me-2 mark' id='addSectionBtn'>Add Questions</a><a href='BackendAPI/deleteDemosection.php?id=$id&sec=" . $row['sr'] . "' class='page-title-icon bg-danger text-white me-2 mark' id='addSectionBtn'>Delete</a></td>";
                                                echo "</tr>"; // End the row
                                                $i++;
                                            }
                                        }
