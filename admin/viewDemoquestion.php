    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            ...
            ";
                ...
                <?php
                $sqee = "SELECT name FROM demosections WHERE sr = '$sec' AND id = '$id'";
                        ...
                        <div class="col stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    $va = "";
                                    $sqq = "SELECT examName FROM demoexam WHERE id = '$id'";
                                    $resu = $mysql_connection->query($sqq);
                                    if ($resu && $resu->num_rows > 0) {
                                        $rew = $resu->fetch_assoc();
                                        $va = $rew['examName'];
                                        echo "<h4 class='card-title'>Add question for " . $rew['examName'] . "</h4>";
                                    } else {
                ...
                <div class="page-header">
                    <h3 class="page-title">
                        <a href="addDemoSection.php?id=<?= $id ?>" class="txt-primary"
                ...
                <div class="row">
                    <?php
                    $quest = "SELECT * FROM demoq_$id WHERE exam_id = '$id' AND section = '$sec'";
                    try {
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        $('#submitForm').click(function () {
                            ...
                            $.ajax({
                                url: 'BackendAPI/addDemoquestion.php',
                                method: 'POST',
                                data: formData,
                                processData: false,
                                contentType: false,
                        ...
                        $('.deleteBtn').click(function () {
                            ...
                            if (confirmDelete) {
                                ...
                                $.ajax({
                                    url: 'BackendAPI/deleteDemoQuestion.php', // Change to the actual path of your backend script
                                    method: 'POST',
