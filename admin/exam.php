                                    ...
                                    if (sessionRole == 0) {
                                        $.each(data, function (index, item) {
                                            var row = "<tr>" +
                                                ...
                                                "<td><a href='addSection.php?id=" + item['id'] + "' class='btn-gradient-success' style ='padding: 5px; text-decoration: none;'>Add Question</a> <a href='updateExam.php?id=" + item['id'] + "' class='btn-gradient-light' style ='padding: 5px; text-decoration: none;'>Update</a> <a href='print.php?id=" + item['id'] + "&name=" + item['exam_name'] + "' class='btn-primary' style ='padding: 5px; text-decoration: none;'>Print</a> <button class='btn btn-danger btn-sm deleteBtn' data-id='" + item['id'] + "'>Delete</button></td>"
                                            "</tr>";
                                            i++;
                                        ...
                                        $.each(data, function (index, item) {
                                            var row = "<tr>" +
                                                ...
                                                "<td>" + item['time_limit'] + "</td>" +
                                                "<td>" + item['number_of_questions'] + "</td>" +
                                                "<td><a href='addSection.php?id=" + item['id'] + "' class='btn-gradient-success' style ='padding: 5px; text-decoration: none;'>Add Question</a> <a href='updateExam.php?id=" + item['id'] + "' class='btn-gradient-light' style ='padding: 5px; text-decoration: none;'>Update</a> <a href='print.php?id=" + item['id'] + "&name=" + item['exam_name'] + "' class='btn-primary' style ='padding: 5px; text-decoration: none;'>Print</a> </td>"
                                            "</tr>";
                                            i++;
                                            tableBody.append(row);
                                        });
