...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // $insertQuery = "INSERT INTO demoq_$examName (exam_id, description, question, choices, correct_answer, explanation, section)
    //                 VALUES ('$examName', '$description', '$question', '$choices', '$correctAnswer', '$explanation', '$section')";

    $insertQuery = "INSERT INTO demoq_" . $examName . " (exam_id, image_path, description, question, choices, correct_answer, explanation, section) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
