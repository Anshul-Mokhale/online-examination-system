            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">View Practice Result</h4>
                                    ...
                                    <tbody>
                                        ...
                                        if ($resu->num_rows > 0) {
                                            ...
                                            while ($row = $resu->fetch_assoc()) {
                                                ...
                                                <td>
                                                <a href="moreResult.php?id=' . $row['id'] . '" class="btn-gradient-success" style ="padding: 5px; text-decoration: none;">View Result</a>
                                                </td>
                                              </tr>';
                                                $i++;
                                            }
