        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h3 class="page-title">
                        <a href="viewPracresult.php" class="txt-primary" style="font-size: 30px !important;"><i
                ...
                <div class="row">
                    <?php
                    $sqq = "SELECT * FROM msub WHERE student_id = '$id'";
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($resultArray as $val) {
                                            echo '<tr>
                                                    <td class="py-1">' . $i . '</td>';
                                            $exid = $val['exam_id'];
                                            $sqq3 = "SELECT * FROM demoexam WHERE id = '$exid'";
                                            $res11 = $mysql_connection->query($sqq3);
                                            if ($res11->num_rows > 0) {
                                                $vael = $res11->fetch_assoc();
                                            }
                                            echo '<td>' . $vael['course'] . '</td>
                                            <td>' . $vael['examName'] . $val['examNo'] . '</td>
                                            <td>' . number_format($val['total'], 2) . '%</td>
                                         <td>
                                    <a href="examResultP.php?id=' . $val['student_id'] . '&examId=' . $val['exam_id'] . '&no=' . $val['examNo'] . '" class="btn-gradient-light" style="padding: 5px; text-decoration: none;">View Result</a>
                                </td>
                            </tr>';
                                            $i++;
                                        }
